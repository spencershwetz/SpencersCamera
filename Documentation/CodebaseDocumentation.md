...
*   **Camera (`iPhoneApp/Features/Camera`)**
    ...
    *   **`CameraView` (`CameraView.swift`)**: 
        ...
        *   Responds to `UIApplication.didBecomeActiveNotification` and `UIDevice.orientationDidChangeNotification` (though orientation logic might be simplified).
