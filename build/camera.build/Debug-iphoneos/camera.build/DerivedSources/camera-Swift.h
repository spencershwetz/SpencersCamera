...
@interface AppDelegate (SWIFT_EXTENSION(camera))
...
SWIFT_CLASS("_TtC6camera15CameraViewModel")
...
@interface CameraViewModel (SWIFT_EXTENSION(camera)) <AVCaptureFileOutputRecordingDelegate>
...
@interface Item (SWIFT_EXTENSION(camera))
@property (nonatomic, copy) NSDate * _Nullable timestamp;
@end

@class UIDocumentPickerViewController;

SWIFT_CLASS("_TtC6camera25LUTDocumentPickerDelegate")
@interface LUTDocumentPickerDelegate : NSObject <UIDocumentPickerDelegate>
...
SWIFT_CLASS("_TtC6camera14LUTPreviewView")
@interface LUTPreviewView : UIView
...
- (void)orientationWillChange:(NSNotification * _Nonnull)notification;
- (void)layoutSubviews;
...
SWIFT_CLASS("_TtC6camera28OrientationFixViewController")
...
SWIFT_CLASS("_TtC6camera19VideoOutputDelegate")
