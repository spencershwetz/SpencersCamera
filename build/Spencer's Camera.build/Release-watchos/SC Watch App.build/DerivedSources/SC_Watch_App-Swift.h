...
#ifndef SC_WATCH_APP_SWIFT_H
#define SC_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SC_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class WCSession;
@class NSString;
SWIFT_CLASS("_TtC12SC_Watch_App24WatchConnectivityService")
